...
NAVIGATION_KEYWORDS = {
    ...
    'auth_pages': {
        'login': ["登入", "去登入", "登入頁面"],
        'register': ["註冊", "去註冊", "註冊頁面", "加入會員", "成為會員"]
    }
}
...
CARD_COMPARISON_RECOMMENDATION_KEYWORDS = {
    ...
    'other_card_indicators': [
        "其它卡片", "其他卡片", "別的卡片", "其他卡", "別的卡", "其它卡", "的卡", "的卡片"
    ],
    # 銀行限定指示詞
    'bank_limited_indicators': [
        "銀行", "哪一家", "哪個銀行", "在.*銀行"
...
RESPONSE_MESSAGES = {
    'navigation': {
        ...
        'chrome_extension_description': """Chrome Extension 是 Rewardia 的智慧購物助手，主要功能包括：

🔍 **自動偵測購物網站**
- 當您瀏覽購物網站時，extension 會自動識別商家類別
- 支援各大電商平台、實體商店官網等

💳 **即時推薦最佳信用卡**
- 根據偵測到的商家類別，即時推薦回饋率最高的信用卡
- 顯示現金回饋率、紅利點數等詳細資訊

🛡️ **隱私保護**
- 只偵測網站網址和頁面標題，不記錄購物內容
- 所有資料都在本地處理，保護您的購物隱私
...
INTENT_KEYWORDS = {
    ...
    'card_benefit_indicators': ["有什麼優惠", "有什麼回饋", "優惠", "回饋", "有什麼好處", "全部優惠", "所有優惠", "全部回饋", "所有回饋", "卡", "信用卡"],
